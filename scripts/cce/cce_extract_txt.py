...
def parse_cli():
    ...
    arg parser
    """
    p = argparse.ArgumentParser(description="extract cce spectre output in a txt file.")
    p.add_argument("-f", type=str, required=True, help="/path/to/specter/cce/output.h5")
    p.add_argument("-dout", type=str, required=True, help="/path/to/output/file.txt")
    p.add_argument(
        "-field",
        type=str,
        default="Psi4",
