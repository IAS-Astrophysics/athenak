...
f_{\rm ref}=0.1,
\end{equation*}
as a deliberately conservative proxy for the unresolved refractory subset of the gas-phase metal tracer.
...
\begin{equation*}
Z_{\rm gas}=0.02,\qquad D_{\rm tot}=0.004,\qquad a_{\rm gr,s}=3\times10^{-4}\,\mu{\rm m},\qquad f_{\rm ref}=0.1.
\end{equation*}
...
$T=100\,{\rm K}$, \\$n_{\rm H}=30\,{\rm cm^{-3}}$ & $0.64\,{\rm Myr}$ & Dubois quote $t_{\rm acc,Sil}\simeq1.8\,{\rm Myr}$ and $t_{\rm acc,C}\simeq9.5\,{\rm Myr}$ at solar abundance for their fiducial turbulent ISM case & $11.7\,{\rm Myr}$ \\
$T=8000\,{\rm K}$, \\$n_{\rm H}=0.1\,{\rm cm^{-3}}$ & $21.3\,{\rm Myr}$ & Resolved accretion only, with $\alpha_{\rm LB}\ll1$; growth is far slower than in the CNM and not turbulence-boosted & $2.6\times10^4\,{\rm Myr}$ \\
