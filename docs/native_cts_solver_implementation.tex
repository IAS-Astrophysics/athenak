...
three shift components.  It is still damped by \(\omega\).  The residual-checked
line search makes it much harder for this mode to take destructive coupled
Newton directions, but it remains more expensive than the diagonal smoother
because it finite-differences and solves a local \(4\times4\) system at each
active point.
