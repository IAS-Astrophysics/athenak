...
errors = {
    ...
    ('hydro', 'rk2', 'plm', '3'): (1.8e-08,0.29),
    ('hydro', 'rk2', 'ppm4', '3'): (6.2e-09,0.29),
    ('hydro', 'rk2', 'ppmx', '3'): (3.7e-10,0.3),
    ('hydro', 'rk2', 'wenoz', '3'): (3.9e-10,0.26),
    ...
    ('hydro', 'rk3', 'plm', '3'): (1.8e-08,0.29),
    ('hydro', 'rk3', 'ppm4', '3'): (5.3e-09,0.25),
    ('hydro', 'rk3', 'ppmx', '3'): (1.9e-11,0.065),
    ('hydro', 'rk3', 'wenoz', '3'): (3.8e-12,0.064),
    ...
    ('mhd', 'rk2', 'ppm4', '4'): (1.6e-08,0.56),
    ('mhd', 'rk2', 'ppmx', '4'): (1.8e-10,1.17),
    ('mhd', 'rk2', 'wenoz', '4'): (1.1e-10,0.26),
    ('mhd', 'rk2', 'plm', '2'): (2.8e-08,0.32),
    ('mhd', 'rk2', 'ppm4', '2'): (1.6e-08,0.56),
    ('mhd', 'rk2', 'ppmx', '2'): (1.8e-10,1.27),
    ...
    ('mhd', 'rk3', 'ppm4', '0'): (7.2e-09,0.3),
    ('mhd', 'rk3', 'ppmx', '0'): (5e-10,0.24),
    ('mhd', 'rk3', 'wenoz', '0'): (5e-10,0.25),
    ...
    ('mhd', 'rk3', 'ppm4', '6'): (7.2e-09,0.3),
    ('mhd', 'rk3', 'ppmx', '6'): (5e-10,0.24),
    ('mhd', 'rk3', 'wenoz', '6'): (5e-10,0.25)}
