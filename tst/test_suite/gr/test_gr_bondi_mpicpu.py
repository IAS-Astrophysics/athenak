# Automatic test based on GR Bondi Hydrodynamic Accretion
#
...
# Run AthenaK with MPI and arguments
...
def test_run():
    ...
    try:
        ...
        assert results, f"GR Bondi test failed./AthenaK did not run successfully."
