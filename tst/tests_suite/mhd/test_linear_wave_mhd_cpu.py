...
maxerrors={}
maxerrors['rk2'] = np.array([[9e-08, 9e-08, 6e-08, 6e-08, 9e-08, 9e-08, 8e-08, ],
                            [6e-08, 6e-08, 3e-08, 3e-08, 4e-08, 4e-08, 3e-08, ],
                            [1e-08, 1e-08, 2e-09, 2e-09, 2e-10, 2e-10, 4e-10, ],
                            [2e-08, 2e-08, 2e-09, 2e-09, 5e-10, 5e-10, 7e-10, ],])

maxerrors['rk3'] = np.array([[8e-08, 8e-08, 6e-08, 6e-08, 9e-08, 9e-08, 8e-08, ],
                            [3e-08, 3e-08, 3e-08, 3e-08, 4e-08, 4e-08, 3e-08, ],
                            [3e-09, 3e-09, 3e-10, 3e-10, 4e-10, 4e-10, 3e-10, ],
                            [3e-09, 3e-09, 7e-11, 7e-11, 2e-10, 2e-10, 1e-10, ],])
convrates={}
convrates['rk2'] = np.array([[0.3, 0.3, 0.3, 0.3, 0.4, 0.4, 0.3, ],
                            [0.4, 0.4, 0.3, 0.3, 0.6, 0.6, 0.3, ],
                            [0.3, 0.3, 0.3, 0.3, 1.0, 2.0, 0.4, ],
                            [0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, ],])

convrates['rk3'] = np.array([[0.3, 0.3, 0.3, 0.3, 0.4, 0.4, 0.3, ],
                            [0.3, 0.3, 0.3, 0.3, 0.4, 0.4, 0.3, ],
                            [0.3, 0.3, 0.07, 0.07, 0.07, 0.07, 0.07, ],
                            [0.3, 0.3, 0.07, 0.07, 0.1, 0.1, 0.05, ],])
_int = ['rk2', 'rk3']
_recon = ['plm', 'ppm4', 'ppmx', 'wenoz']# do not change order
_wave = ['0','6','1','5','2','4','3']# do not chnage order
_flux = ['llf', 'hlle', 'hlld']
