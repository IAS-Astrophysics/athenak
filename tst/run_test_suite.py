...
parser.add_argument(
    "--cpu", 
    nargs="*", 
    help="Run test on CPU. Can add optional cmake arguments."
)
parser.add_argument(
    "--mpicpu", 
    nargs="*", 
...
parser.add_argument(
    "--gpu", 
    nargs="*", 
    help="Run test on GPU. Can add optional cmake arguments."
)
