...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--input", help="name of input (hst) file")
    parser.add_argument(
    ...
    parser.add_argument(
        "-xlog", "--xlog", action="store_true", help="plot log of x-values"
    )
    parser.add_argument(
        "-ylog", "--ylog", action="store_true", help="plot log of y-values"
    )
