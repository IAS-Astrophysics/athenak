...
namespace Primitive {
  ...
  KOKKOS_INLINE_FUNCTION void LowerVector(Real vd[3], const Real vu[3], const Real g3d[NSPMETRIC]) {
  ...
  KOKKOS_INLINE_FUNCTION void RaiseForm(Real vu[3], const Real vd[3], const Real g3u[NSPMETRIC]) {
