#ifndef EOS_PRIMITIVE_SOLVER_COMPOSE_HPP_
#define EOS_PRIMITIVE_SOLVER_COMPOSE_HPP_
...
*/
  ...
  private:
    ...
    /// Low level evaluation function, not intended for outside use
    KOKKOS_INLINE_FUNCTION Real eval_at_lnty(int iv, Real log_n, Real log_t, Real yq) const {
      int in, iy, it;
    ...
    KOKKOS_INLINE_FUNCTION void weight_idx_ln(Real *w0, Real *w1, int *in, Real log_n) const {
    ...
    KOKKOS_INLINE_FUNCTION void weight_idx_lt(Real *w0, Real *w1, int *it, Real log_t) const {
    ...
    KOKKOS_INLINE_FUNCTION Real temperature_from_var(int iv, Real var, Real n, Real Yq) const {
      int in, iy;
...
#endif //EOS_PRIMITIVE_SOLVER_COMPOSE_HPP_
