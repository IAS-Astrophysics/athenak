...
void AdiabaticMHD::ConsToPrim(const DvceArray5D<Real> &cons, DvceArray5D<Real> &prim)
{
}
...
void AdiabaticMHD::ConsToPrim(const DvceArray5D<Real> &cons,const DvceFaceFld4D<Real> &b,
