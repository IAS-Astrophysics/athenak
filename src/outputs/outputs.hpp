...
static const char *var_choice[NOUTPUT_CHOICES] = {
  ...
  // radiation M1 fluid-frame derived quantities (165-170)
  "rad_m1_J", "rad_m1_H", "rad_m1_n", "rad_m1_fnu",
  "rad_m1_e", "rad_m1_absF",

  // lower time-component of the fluid four-velocity (171)
  "u_t",

  // WinNet velocity (172)
  "win_Vi",

  // Spherical radius (173)
  "r_sph",
};
