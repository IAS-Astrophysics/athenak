  ...
  KOKKOS_LAMBDA(TeamMember_t member, const int m, const int k, const int j) {
    ...
    switch (recon_method_) {
      ...
      case ReconstructionMethod::teno:
        TENOX1(member, eos_, false, m, k, j, il-1, iu, w0_, wl, wr);
      ...
      for (int j=jl; j<=ju; ++j) {
        ...
        switch (recon_method_) {
          ...
          case ReconstructionMethod::wenoz:
            ...
            break;
          case ReconstructionMethod::teno:
            TENOX2(member, eos_, false, m, k, j, is-1, ie+1, w0_, wl_jp1, wr);
      ...
      for (int k=kl; k<=ku; ++k) {
        ...
        switch (recon_method_) {
          ...
          case ReconstructionMethod::wenoz:
            ...
            break;
          case ReconstructionMethod::teno:
            TENOX3(member, eos_, false, m, k, j, is-1, ie+1, w0_, wl_kp1, wr);
