  ...
  for (int m=0; m<nmb; ++m) {
    ...
    switch (pmy_pack->pmb->mb_bcs(m,BoundaryFace::inner_x1)) {
      ...
      case BoundaryFlag::user:
        pmy_pack->pmesh->BoundaryFunc[BoundaryFace::inner_x1](m, coord, u0_);
        break;
      default:
        break;
    }
    ...
    switch (pmy_pack->pmb->mb_bcs(m,BoundaryFace::outer_x1)) {
      ...
      case BoundaryFlag::periodic:
        ...
        break;
      case BoundaryFlag::user:
        pmy_pack->pmesh->BoundaryFunc[BoundaryFace::outer_x1](m, coord, u0_);
        break;
      default:
        break;
    }
  ...
  for (int m=0; m<nmb; ++m) {
    ...
    switch (pmy_pack->pmb->mb_bcs(m,BoundaryFace::inner_x2)) {
      ...
      case BoundaryFlag::outflow:
        ...
        break;
      case BoundaryFlag::user:
        pmy_pack->pmesh->BoundaryFunc[BoundaryFace::inner_x2](m, coord, u0_);
        break;
      default:
        break;
    }
    ...
    switch (pmy_pack->pmb->mb_bcs(m,BoundaryFace::outer_x2)) {
      ...
      case BoundaryFlag::outflow:
        ...
        break;
      case BoundaryFlag::user:
        pmy_pack->pmesh->BoundaryFunc[BoundaryFace::outer_x2](m, coord, u0_);
        break;
      default:
        break;
    }
  ...
  for (int m=0; m<nmb; ++m) {
    ...
    switch (pmy_pack->pmb->mb_bcs(m,BoundaryFace::inner_x3)) {
      ...
      case BoundaryFlag::outflow:
        ...
        break;
      case BoundaryFlag::user:
        pmy_pack->pmesh->BoundaryFunc[BoundaryFace::inner_x3](m, coord, u0_);
        break;
      default:
        break;
    }
    ...
    switch (pmy_pack->pmb->mb_bcs(m,BoundaryFace::outer_x3)) {
      ...
      case BoundaryFlag::outflow:
        ...
        break;
      case BoundaryFlag::user:
        pmy_pack->pmesh->BoundaryFunc[BoundaryFace::outer_x3](m, coord, u0_);
        break;
      default:
        break;
    }
