...
ProblemGenerator::ProblemGenerator(ParameterInput *pin, Mesh *pm) :
  ...
  } else if (pgen_fun_name.compare("rad_femn_cylindertest") == 0) {
  ...
  } else if (pgen_fun_name.compare("rad_femn_shadowtest") == 0) {
    RadiationFEMNShadowtest(pin, false);
  } else if (pgen_fun_name.compare("rad_femn_dopplertest") == 0) {
  ...
  } else if (pgen_fun_name.compare("rad_femn_beamtest_kerrschild") == 0) {
    RadiationFEMNBeamtestKS(pin, false);
