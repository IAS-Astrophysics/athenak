...
//========================================================================================
//! \file radiation_m1_tov.cpp
//  \brief Problem generator for radiation m1 TOV star. Only works when ADM is enabled.
...
//  Compile with '-D PROBLEM=radiation_m1_tov' to enroll as user-specific problem generator
...
void ProblemGenerator::UserProblem(ParameterInput *pin, const bool restart) {
  ...
  if (pmbp->pradm1 == nullptr) {
    std::cout << "### FATAL ERROR in " << __FILE__ << " at line " << __LINE__ << std::endl
              << "The radiation m1 tov problem generator can only be run with "
                 "radiation-m1, but no "
