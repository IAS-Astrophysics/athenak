...
//! Simplified and implemented in Kokkos by JMS, toroidal field configuration by GH.
//!
//! References:
...
struct torus_pgen {
  ...
  Real pol_frac;			      // set ratio of poloidal to toroidal field
};
...
void ProblemGenerator::UserProblem(ParameterInput *pin, const bool restart) {
  ...
  if (pmbp->pmhd != nullptr) {
    ...
    torus.pol_frac           = pin->GetOrAddReal("problem","pol_frac", 1.0);
