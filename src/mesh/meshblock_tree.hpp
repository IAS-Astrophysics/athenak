...
// The MeshBlockTree stores the logical grid structure, and is used for neighbor searches, storing
// global IDs, etc.  Levels refer to "logical level", where the logical root (single block) level
// is 0 (see Figs. 1 and 3 of method paper). Note the logical level of the physical root grid
// (user-specified root grid) will be greater than zero if it contains more than one MeshBlock
//
