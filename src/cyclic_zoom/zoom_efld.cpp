...
void ZoomData::StoreEFieldsAfterAMR(int zm, int m, DvceEdgeFld4D<Real> efld) {
  ...
  KOKKOS_LAMBDA(const int ck, const int cj, const int ci) {
    ...
    if (ck==cks && cj==cjs && ci==cis) {
      printf("ZoomData::StoreEFieldsAfterAMR zm=%d m=%d rad=%e ep1=%e, ef1=%e de1=%e\n",
             zm, m, rad, ep1(zm,ck,cj,ci), ef1(m,k,j,i), de1(zm,ck,cj,ci));
      printf("ZoomData::StoreEFieldsAfterAMR zm=%d m=%d rad=%e ep2=%e, ef2=%e de2=%e\n",
             zm, m, rad, ep2(zm,ck,cj,ci), ef2(m,k,j,i), de2(zm,ck,cj,ci));
      printf("ZoomData::StoreEFieldsAfterAMR zm=%d m=%d rad=%e ep3=%e, ef3=%e de3=%e\n",
