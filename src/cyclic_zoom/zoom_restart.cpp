...
void CyclicZoom::WriteRestartFile(IOWrapper &resfile) {
  ...
  Kokkos::deep_copy(outefld_zoom.x1f, pzdata->efld_pre.x1e);
  Kokkos::deep_copy(outefld_zoom.x2f, pzdata->efld_pre.x2e);
  Kokkos::deep_copy(outefld_zoom.x3f, pzdata->efld_pre.x3e);
  ...
  Kokkos::deep_copy(outefld_zoom.x1f, pzdata->efld_aft.x1e);
  Kokkos::deep_copy(outefld_zoom.x2f, pzdata->efld_aft.x2e);
  Kokkos::deep_copy(outefld_zoom.x3f, pzdata->efld_aft.x3e);
  resfile.Write_any_type(e1ptr.data(),e1ptr.size(),"Real");
  resfile.Write_any_type(e2ptr.data(),e2ptr.size(),"Real");
  resfile.Write_any_type(e3ptr.data(),e3ptr.size(),"Real");
...
void CyclicZoom::ReadRestartFile(IOWrapper &resfile) {
  ...
  if (global_variable::my_rank == 0) { // the master process reads the variables data
    ...
    Kokkos::deep_copy(zein.x1f, pzdata->efld_pre.x1e);
    Kokkos::deep_copy(zein.x2f, pzdata->efld_pre.x2e);
    Kokkos::deep_copy(zein.x3f, pzdata->efld_pre.x3e);
    resfile.Read_Reals(e1ptr.data(), e1ptr.size());
    resfile.Read_Reals(e2ptr.data(), e2ptr.size());
    resfile.Read_Reals(e3ptr.data(), e3ptr.size());
    Kokkos::deep_copy(zein.x1f, pzdata->efld_aft.x1e);
    Kokkos::deep_copy(zein.x2f, pzdata->efld_aft.x2e);
    Kokkos::deep_copy(zein.x3f, pzdata->efld_aft.x3e);
    resfile.Read_Reals(e1ptr.data(), e1ptr.size());
    resfile.Read_Reals(e2ptr.data(), e2ptr.size());
    resfile.Read_Reals(e3ptr.data(), e3ptr.size());
  ...
  Kokkos::deep_copy(hfld.x1f, pzdata->efld_pre.x1e);
  Kokkos::deep_copy(hfld.x2f, pzdata->efld_pre.x2e);
  Kokkos::deep_copy(hfld.x3f, pzdata->efld_pre.x3e);
  ...
  Kokkos::deep_copy(pzdata->efld_pre.x1e, hfld.x1f);
  Kokkos::deep_copy(pzdata->efld_pre.x2e, hfld.x2f);
  Kokkos::deep_copy(pzdata->efld_pre.x3e, hfld.x3f);
  Kokkos::deep_copy(hfld.x1f, pzdata->efld_aft.x1e);
  Kokkos::deep_copy(hfld.x2f, pzdata->efld_aft.x2e);
  Kokkos::deep_copy(hfld.x3f, pzdata->efld_aft.x3e);
  MPI_Bcast(hfld.x1f.data(), hfld.x1f.size(), MPI_ATHENA_REAL, 0, MPI_COMM_WORLD);
  MPI_Bcast(hfld.x2f.data(), hfld.x2f.size(), MPI_ATHENA_REAL, 0, MPI_COMM_WORLD);
  MPI_Bcast(hfld.x3f.data(), hfld.x3f.size(), MPI_ATHENA_REAL, 0, MPI_COMM_WORLD);
  Kokkos::deep_copy(pzdata->efld_aft.x1e, hfld.x1f);
  Kokkos::deep_copy(pzdata->efld_aft.x2e, hfld.x2f);
  Kokkos::deep_copy(pzdata->efld_aft.x3e, hfld.x3f);
