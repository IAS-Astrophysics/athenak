...
def build_cases(root: Path, run_dir: Path) -> list[Case]:
    ...
    cases = [
        ...
        athena_case("stress_positivity_floor", athena,
                    "inputs/tests/dynrad_positivity_floor.athinput", run_dir),
        athena_case("stress_positivity_floor_adm", athena,
                    "inputs/tests/dynrad_positivity_floor.athinput", run_dir,
                    "dyn_radiation/geometry=adm"),
        athena_case("stress_source_iteration", athena,
                    "inputs/tests/dynrad_source_iteration.athinput", run_dir),
        athena_case("stress_flrw_redshift", athena,
                    "inputs/tests/dynrad_flrw_redshift.athinput", run_dir),
        athena_case("stress_lapse_gradient", athena,
                    "inputs/tests/dynrad_lapse_gradient.athinput", run_dir),
        athena_case("stress_momentum_source", athena,
                    "inputs/tests/dynrad_momentum_source.athinput", run_dir),
