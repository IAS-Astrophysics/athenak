...
INPUT_DECK="${INPUT_DECK:-${REPO_DIR}/inputs/tde/aurora/z4c_tov_ks_n3_schwarzschild_headon_density_amr_64c_aurora.athinput}"
JOB_NAME="${JOB_NAME:-z4c_headon_density_amr64}"
