...
DEFAULT_CASE="minkowski_static_selfgrav_starfloor_smallbox_diag_2n"
DEFAULT_DECK="${REPO_DIR}/inputs/tde/aurora/z4c_tov_ks_n3_minkowski_static_selfgrav_starfloor_smallbox_diag_2n_aurora.athinput"

CASE_NAME="${CASE_NAME:-${DEFAULT_CASE}}"
INPUT_DECK="${INPUT_DECK:-${DEFAULT_DECK}}"
JOB_NAME="${JOB_NAME:-z4c_instab_2n}"
QUEUE="${QUEUE:-debug}"
SELECT_RESOURCE="${SELECT_RESOURCE:-2}"
...
vars="CASE_NAME=${CASE_NAME},INPUT_DECK=${INPUT_DECK},REPO_DIR=${REPO_DIR},PROJECT_ROOT=${PROJECT_ROOT},RUN_ROOT=${RUN_ROOT},POST_ROOT=${POST_ROOT},BUILD_DIR=${BUILD_DIR},ATHENA_EXE=${ATHENA_EXE},RANKS_PER_NODE=${RANKS_PER_NODE},ATHENA_WALLTIME=${ATHENA_WALLTIME},POSTPROCESS=${POSTPROCESS}"
