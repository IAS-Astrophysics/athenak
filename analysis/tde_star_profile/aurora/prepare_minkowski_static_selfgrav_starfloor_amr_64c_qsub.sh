...
CASE_NAME="${CASE_NAME:-minkowski_static_selfgrav_starfloor_amr_64c}"
INPUT_DECK="${INPUT_DECK:-${REPO_DIR}/inputs/tde/aurora/z4c_tov_ks_n3_minkowski_static_selfgrav_starfloor_amr_64c_aurora.athinput}"
JOB_NAME="${JOB_NAME:-z4c_static_sg_floor64}"
